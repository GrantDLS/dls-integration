...
import { OAuthAuthorization } from '@core/auth/OAuthAuthorization';
import { User, UserRole } from '@core/models/User';
import { GetOrCreateInstitutionInput } from '@core/resolvers/mutations/UpsertUserMutation';

export class UserAuthorization extends OAuthAuthorization {
  constructor() {
    super();
  }
